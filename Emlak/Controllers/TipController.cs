...
namespace Emlak.Controllers
{
    public class TipController : Controller
    {
        ...
        {
            var durumtip1=db.Tips.Where(t => t.DurumId == 1).ToList(); // Durumu 1 olan tipleri listelicek ..
        ...
        {
            var durumtip2 = db.Tips.Where(t => t.DurumId == 2).ToList(); // Durumu 2 olan tipleri listelicek ..
